...
# T05: Close documentation and capability posture from final S04 evidence

Why: S04 must leave downstream slices with a truthful capability matrix and reader-facing proof ledger. Native artifact surfaces may only be promoted if T04 produced live version/build/readback evidence; all other surfaces and agent/adapter execution paths must remain conservative. Do:
